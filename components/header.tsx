...
export default function Header() {
  ...
  return (
    <header className="z-[999] relative">
      ...
      quality="25"
      priority={true}
      className="p-1 mr-15 dark:bg-white  dark:border-black/10 dark:bg-opacity-85  h-12 w-12 rounded-full object-cover border-[0.35rem] border-white shadow-xl"
    /></motion.div>
            ...
            >
              ...
              >
                ...
                {link.name === activeSection && (
                  <motion.span
                    className="bg-gray-100 rounded-full absolute inset-0 -z-10 dark:bg-gray-800 dark:bg-c"
